...
Script Name: SCP_03_DecisionTree_Model_V1.py

Script Description : This script loads the pre-processed files, split the data into 80-20% training-test set
                     and applies Decision Tree model with each level containing all the features. 
...
MODEL_FILENAME = "DT_Model_V1.pickle"
